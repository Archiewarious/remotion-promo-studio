...
На ПК должны стоять **Node ≥ 20**, **FFmpeg** и **Python 3** (ссылки — в [Требованиях](#требования)).

1. Скачай или клонируй эту папку.
2. Открой в ней Claude Code.
3. Напиши: **«настрой воркспейс»** — Claude поставит зависимости и проверит окружение.

Дальше просто скажи:
> «Делаем видео про **тема**. ТЗ: **текст или ссылка**»

Claude задействует навык **`video-pipeline`** — весь процесс от ТЗ до 4K-финала: общий движок, правила Remotion и slash-команды ниже.
