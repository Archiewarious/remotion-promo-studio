...
> (отработано в `E:\Video_Archive\ArchivedProject\WORKFLOW.md` (в архиве)). В Claude Code на ПК НЕ нужно — рендер локальный.
...
Подробный sandbox-воркфлоу — `E:\Video_Archive\ArchivedProject\WORKFLOW.md` (в архиве).
